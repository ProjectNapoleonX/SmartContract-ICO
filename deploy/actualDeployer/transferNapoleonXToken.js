...
// Synchronous read
var data = fs.readFileSync('./data/allMissedContributions_transfer.csv').toString().split('\n');
...
for (var i = 0; i < data.length; i++) {
	...
	console.log("Handling@transfered@"+myAddress+"@tokenAmount@"+myAmount);
	console.log("Sending populating batch");
	console.log("Batch gas estimation");
	var napoleonXtokenPopulateData=napoleonXToken.transfer.getData(myAddress,myAmount);
	...
	var napoleonXtokenPopulateDataEstimate = Math.min(web3.eth.getBlock("latest").gasLimit,napoleonXtokenPopulateDataEstimate+500);
	console.log(napoleonXtokenPopulateDataEstimate);
